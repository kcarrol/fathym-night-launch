      ...
      <section className="py-20 md:py-28 border-t border-border/50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground text-center mb-12">Fathym is designed for teams building real systems, not just experiments real systems, not just experiments.<span className="text-foreground font-medium">real systems</span>, not just experiments:
            </p>
