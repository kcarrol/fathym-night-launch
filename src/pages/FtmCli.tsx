...
const FtmCli = () => {
  ...
  const workflowSteps = [{
    ...
    step: 3,
    title: "Design and propose change"
  }, {
    step: 4,
    title: "Require approval"
  }, {
    step: 5,
    title: "Apply deterministically"
  }];
  const audiences = [{
    icon: Layers,
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="p-8 rounded-xl border border-border bg-background/50 border-glow">
                ...
                <div className="space-y-4">
                  ...
                  icon: Shield,
                  text: "Deterministic guarantees"
                }, {
                  icon: FileCheck,
                  text: "Reviewable change"
                }, {
                  icon: History,
                  text: "Traceability over time"
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {cliFeatures.map((feature, index) => <div key={index} className="p-6 rounded-xl border border-border bg-card/30 hover:border-secondary/50 transition-colors group">
      ...
      <section className="py-24 bg-card/30 relative">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">FTM does not replace </h2>
                
                <div className="grid grid-cols-2 gap-4 mb-8">
                  {["Cloud CLIs", "CI/CD pipelines", "IDEs", "AI copilots"].map((tool, index) => <div key={index} className="p-4 rounded-lg border border-border/50 bg-background/30">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {["AI can assemble new systems from scratch", "AI can evolve existing systems safely", "Visual and conversational interfaces become possible without breaking governance"].map((item, index) => <div key={index} className="p-6 rounded-xl border border-border bg-background/50 hover:border-primary/50 transition-colors">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {audiences.map((audience, index) => <div key={index} className="p-6 rounded-xl border border-border bg-card/30 hover:border-primary/50 transition-colors group text-center">
