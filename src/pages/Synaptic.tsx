        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Synaptic structures AI execution using two core primitives: <strong className="text-foreground">neurons</strong> and <strong className="text-foreground">circuits</strong>.
              </p>
              <p className="text-muted-foreground mb-6">
                <strong className="text-foreground">Neurons</strong> are small, focused units of AI behavior — such as prompting, reasoning, or invoking a capability. Each neuron has defined inputs, outputs, and scope.
              </p>
              <p className="text-muted-foreground mb-8">
                <strong className="text-foreground">Circuits</strong> compose neurons into explicit execution flows. They define how AI behavior progresses, how state moves, and where decisions are made.
              </p>
              <p className="text-muted-foreground mb-4">This structure makes AI workflows:</p>
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3 text-muted-foreground">
                  <CheckCircle className="w-4 h-4 text-primary" />
                  Composable rather than entangled
                </li>
                <li className="flex items-center gap-3 text-muted-foreground">
                  <CheckCircle className="w-4 h-4 text-primary" />
              ...
              <div className="relative mb-8">
                ...
                <div className="relative rounded-2xl border border-border bg-card/50 backdrop-blur-sm p-8">
                  <h3 className="font-display text-xl font-semibold mb-4 text-foreground flex items-center gap-3">
                    ...
                    Circuits are system artifacts
                  </h3>
                  <p className="text-muted-foreground mb-6">
                    In Synaptic, circuits are declared as part of Everything as Code. That means AI workflows can be:
                  </p>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-muted-foreground">
                      <CheckCircle className="w-4 h-4 text-secondary" />
                      Executed under identity and policy
                    </div>
                    <div className="flex items-center gap-3 text-muted-foreground">
                      <CheckCircle className="w-4 h-4 text-secondary" />
                    ...
                    <div className="flex items-center gap-3 text-muted-foreground">
                      <CheckCircle className="w-4 h-4 text-secondary" />
                      Reused across environments and runtimes
                    </div>
                  </div>
                  <p className="text-sm text-muted-foreground mt-6 border-t border-border pt-6">
                    AI behavior is no longer hidden in prompt chains. It becomes part of the system.
                  </p>
                </div>
              </div>
              
              {/* Circuit Diagram */}
              <div className="rounded-2xl border border-secondary/30 bg-secondary/5 p-6 font-mono text-sm">
                <div className="flex items-center justify-center gap-2 flex-wrap">
                  <div className="border border-secondary/50 rounded px-3 py-2 text-center">
                    <div className="text-secondary">Neuron</div>
                ...
                <div className="text-center text-muted-foreground mt-3 text-xs">
                  └────────────── Circuit ──────────────┘
                </div>
              </div>
              
              <p className="text-muted-foreground mt-6 text-sm">
                This is what allows Synaptic to move AI execution between systems, across environments — without losing control or context. AI operates inside the system model, not alongside it.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-border bg-card/50 backdrop-blur-sm p-8">
                <h3 className="font-display text-xl font-semibold mb-6 text-foreground">Synaptic adds</h3>
                <div className="space-y-4">
